...
sqlcmd /S localhost,1434 /d eenmaalandermaal -U sa -P abc123!@# -Q "SET NOCOUNT ON" -x
ECHO Adding eenmaalandermaal.
sqlcmd /S localhost,1434 /d eenmaalandermaal -U sa -P abc123!@# -i"%CD%\eenmaalandermaal\CREATE_EA.sql" -x
sqlcmd /S localhost,1434 /d eenmaalandermaal -U sa -P abc123!@# -i"%CD%\eenmaalandermaal\ADD_DBUSER_EA.sql" -x
sqlcmd /S localhost,1434 /d eenmaalandermaal -U sa -P abc123!@# -i"%CD%\eenmaalandermaal\INSERT_EA.sql" -x

ECHO Adding databatch tables.
START /min sqlcmd /S localhost,1434 /d datadump -U sa -P abc123!@# -i"%dataBatchPath%\GBALanden.sql" -x
sqlcmd /S localhost,1434 /d datadump -U sa -P abc123!@# -i"%dataBatchPath%\CREATE Tables.sql" -x
START /min sqlcmd /S localhost,1434 /d datadump -U sa -P abc123!@# -i"%CD%\databatch_convert\removeconstraints.sql" -x

ECHO Adding categories
sqlcmd /S localhost,1434 /d datadump -U sa -P abc123!@# -i"%dataBatchPath%\CREATE Categorieen.sql" -x
...
for /d %%D in ("%dataBatchPath%\*") do (
    ...
    for %%F in ("%%D\*.sql") do (
        ...
        START /min sqlcmd /S "localhost,1434" /d "datadump" -U "sa" -P "abc123!@#" -i"%%F" -x -f 65001
    )
)
ping -n 4 ::1 >nul 2>&1
...
IF %runningScripts% == 1 (
    ...
    :START
    sqlcmd /S localhost,1434 /d datadump -U sa -P abc123!@# -i"%CD%\databatch_convert\convertdatalocal.sql" -x 
...
sqlcmd /S localhost,1434 /d eenmaalandermaal -U sa -P abc123!@# -i"%CD%\eenmaalandermaal\INSERT_voorbeeldata.sql" -x
GOTO removeHTML
...
sqlcmd /S localhost,1434 /d eenmaalandermaal -U sa -P abc123!@# -i"%CD%\databatch_convert\removeHTML.sql" -x 
